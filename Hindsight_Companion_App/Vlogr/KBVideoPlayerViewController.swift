...
//        playerLayer.masksToBounds = true
        ...
        timeRemainingLabel.layer.cornerRadius = 7
...
//        VideoPlayerView.layer.shadowRadius = 5
        ...
        VideoPlayerView.addGestureRecognizer(swipeToDismiss)
        
        //Tap to play
        let tapToPlayorPause = UITapGestureRecognizer(target: self, action: #selector(pauseOrPlay))
        VideoPlayerView.addGestureRecognizer(tapToPlayorPause)
...
//[Principium: Playback controls method/properties]
    ...
    @objc fileprivate func pauseOrPlay(){
        print(#function)
